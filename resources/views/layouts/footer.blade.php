    ...
    <div class="container">
        <div class="row row-cols-lg-3 row-cols-1 justify-content-between">
            <div class="col col-lg-6 mb-lg-0 mb-4">
                <a href="{{ '/' }}" class="text-white fs-2">BeRent.</a>
                <p class="text-white-50 my-4">BeRent adalah sebuah website yang menyediakan layanan penyewaan alat Bengkel secara online <br>
        ...
        <div class="row">
            <div class="col">
                <p class="text-white text-center copytext">&copy; Copyright 2023 by Zoldyck, All Right Reserved.</p>
            </div>
        </div>
    </div>
</div>
